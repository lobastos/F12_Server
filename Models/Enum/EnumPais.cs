namespace LibsServer.Model.Enum
{
    public enum Paises
    {
        ...
        ANGUILLA = 418,
        ANTARTICA = 420,
        ANTIGUA_E_BARBUDA = 434,
        ANTILHAS_HOLANDESAS = 477,
        ARABIA_SAUDITA = 531,
        ARGELIA = 590,
        ARGENTINA = 639,
        ARMENIA__REPUBLICA_DA = 647,
        ARUBA = 655,
        AUSTRALIA = 698,
        AUSTRIA = 728,
        AZERBAIJAO__REPUBLICA_DO = 736,
        BAHAMAS__ILHAS = 779,
        BAHREIN__ILHAS = 809,
        BANGLADESH = 817,
        BARBADOS = 833,
        BELARUS__REPUBLICA_DA = 850,
        BELGICA = 876,
        BELIZE = 884,
        BERMUDAS = 906,
        MIANMAR = 930,
        BOLIVIA__ESTADO_PLURINACIONAL_DA = 973,
        BOSNIA_HERZEGOVINA = 981,
        BONAIRE = 990,
        BOTSUANA = 1015,
        BOUVET, ILHA = 1023,
        /// <summary>
